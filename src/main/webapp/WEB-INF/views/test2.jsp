...
<div class="container-fluid">
	<div class="row">
		...
		<li>
			...
			<c:if test="${wordTest.answer==false}">
		...
		<br/><br/>
			...
			<br/><br/>
			<form method="post">
			<input name="userAnswer" autocomplete="off" autofocus type="text" style="font-size:80px;text-align: center; width:738px;border: 2px solid #428bca; border-radius: 5px;">
			<br/><br/>
			<c:choose>
